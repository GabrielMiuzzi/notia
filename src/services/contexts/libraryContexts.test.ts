...
describe('library context helpers', () => {
  ...
  it('provides the default contexts and removes duplicate tags', () => {
    expect(DEFAULT_LIBRARY_CONTEXTS.map((context) => context.tag)).toEqual(['#Laboral', '#Personal', '#Academico', CONFIDENTIAL_CONTEXT_TAG])
