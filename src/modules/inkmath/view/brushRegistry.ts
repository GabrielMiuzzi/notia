import type { InkMathBrushId, InkMathStrokeStyle, InkMathStrokeTool } from "../types";
...
export type BrushPreset = {
	id: InkMathBrushId | string;
	label: string;
	tool: InkMathStrokeTool | "eraser";
	defaultWidth: number;
...
const parseBrushPreset = (value: unknown): BrushPreset | null => {
	...
	return {
		...
		defaultOpacity,
		style: style as InkMathStrokeStyle,
		texture,
