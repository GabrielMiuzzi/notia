...
export function FinanceServicesView({ library }: { library: NotiaLibrary }) {
  ...
  async function save(event: FormEvent<HTMLFormElement>) {
    ...
    try { await applyFinanceUiChange(library, { kind: "save-service", service: editing }); setEditing(null); await refresh() } catch (reason) { setError(financeErrorMessage(reason, "No se pudo guardar el servicio.")) }
  }
