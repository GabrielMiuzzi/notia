...
describe("FinanceRecordsPanel accessibility", () => {
  it("exposes a labelled region and visible touch actions", () => {
    const html = renderToStaticMarkup(<FinanceRecordsPanel library={{ id: "library", name: "Personal", path: "C:/personal" }} accounts={[]} categories={[]} reserves={[]} debtRatioHistory={[]} historyFrom="2025-10" historyTo="2026-09" onChanged={async () => undefined} />);
