...
export const DEFAULT_BOARDS: Array<{ name: string; color: string; activityHoursPerDay: number; contexto: string }> = [
  { name: DEFAULT_BOARD_NAME, color: '#2e6db0', activityHoursPerDay: 24, contexto: '#Personal' },
]
