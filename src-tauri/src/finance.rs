...
mod tests {
    ...
    fn audit_returns_a_result_when_card_evidence_covers_an_unpaid_occurrence() {
        ...
        connection
            .execute_batch(
                "INSERT INTO finance_source_artifacts(id,source_type,reference,raw_text,created_at)
                 ...
                 VALUES('audit-card-transaction','expense','82997.00','ARS','2026-08-19','dev-account-card','MOVISTAR ARGENTINA 82997','credit_card_statement','confirmed',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
                 ...
                 VALUES('audit-card-statement','dev-account-card','Banco Test','9999','2026-08','2026-08-25','2026-09-05','ARS','0.00','0.00','0.00','82997.00','0.00','0.00','0.00','82997.00','8299.70','audit-card-artifact','confirmed',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
        ...
        assert!(result
            .proposals
            .iter()
            .all(|proposal| proposal.proposal_type != "service-unpaid"));
    }
}
