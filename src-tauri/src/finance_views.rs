...
#[tauri::command]
pub fn finance_period_summary(app: tauri::AppHandle, payload: PeriodSummaryPayload) -> FinanceCommandResult<PeriodSummary> {
...
#[tauri::command]
pub fn finance_relation_audit(app: tauri::AppHandle, payload: RelationAuditPayload) -> FinanceCommandResult<RelationAudit> {
    let context = payload.context;
