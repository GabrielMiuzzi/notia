...
fn open_connection(context: &RoutineContext, app: &tauri::AppHandle) -> RoutineResult<Connection> {
...
fn sync_library_connection(context: &RoutineContext, app: &tauri::AppHandle) -> RoutineResult<()> {
    #[cfg(target_os = "android")]
    {
        let directory_uri = context
            .android_directory_uri
